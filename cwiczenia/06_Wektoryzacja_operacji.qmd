...
6. Napisz funkcję, która przyjmie wektor liczbowy, a następnie zliczy ile liczb
mieści się w jednym odchyleniu standardowym od średniej wartości oraz obliczy
odsetek tych liczb.
7. Napisz funkcję, która przyjmie dwa wektory tekstowe, a następnie porówna
