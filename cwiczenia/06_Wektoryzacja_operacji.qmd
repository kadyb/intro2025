...
dłuższego wektora, to zostanie zwrócone ostrzezenie, a wynikowa długość nie
...
Jednak, możemy ten kod znacząco uprościć używająć zwektoryzowanej instrukcji
...
R zapewnia również bogaty zestaw zwektoryzowanych funkcji dla różnego rodzaju
operacji i zadań, np. matematyczne, statystyczne, przetwarzania tekstu, itd.
...
Do tej pory omówliśmy podstawowe techniki wektoryzacji operacji. Niemniej,
dostępne są również dodatkowe narzędzia, w szczególności służące do wektoryzacji
operacji na bardziej złożonych strukturach danych niż wektory. W tym celu stsowana
...
liczobwych i obliczmy średnią dla każdego z nich.
