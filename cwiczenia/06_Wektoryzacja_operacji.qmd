...
1. Napisz pętlę, która doda wartości odpowiadających sobie elementów dwóch
wektorów: `10, 20, 30, 40` i `40, 30, 20, 10`. Następnie wykonaj to samo działanie,
ale używając podejścia zwektoryzowanego.
